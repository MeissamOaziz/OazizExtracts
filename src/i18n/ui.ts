...
const fr: Dict = {
  ...
  'curado.fruit.title':  'Curado Fruit 1.5g',
  'curado.fruit.blurb':  'Des saveurs fruitées et une puissance constante.',
  'curado.fruit.b1':     'Distillat de qualité supérieure',
  'curado.fruit.b2':     'Profil de terpènes riche',
  'curado.fruit.b3':     'Format 510 pratique',
  'curado.med.tc':       'Curado Tropicana Cookies Vape',
  'curado.med.bcp':      'Curado Black Cherry Punch Vape',
  'curado.med.po':       'Curado Purple Octane Vape',
  'curado.med.fruit':    'Curado Fruit 1.5g Vape',
...
const en: Dict = {
  ...
  'curado.fruit.title':  'Curado Fruit 1.5g',
  'curado.fruit.blurb':  'Fruity flavors and steady potency.',
  'curado.fruit.b1':     'Premium distillate',
  'curado.fruit.b2':     'Rich terpene profile',
  'curado.fruit.b3':     'Convenient 510 format',
  'curado.med.tc':       'Curado Tropicana Cookies Vape',
  'curado.med.bcp':      'Curado Black Cherry Punch Vape',
  'curado.med.po':       'Curado Purple Octane Vape',
  'curado.med.fruit':    'Curado Fruit 1.5g Vape',
