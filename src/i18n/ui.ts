...
const fr: Dict = {
  ...
  'curado.po.title':     'Curado Purple Octane 1.5g',
  'curado.po.blurb':     'Une expérience de vapotage puissante et savoureuse.',
  'curado.po.b1':        'Distillat haut de gamme',
  'curado.po.b2':        'Teneur élevée en THC',
  'curado.po.b3':        "Format prêt à l'emploi",
...
const en: Dict = {
  ...
  'curado.po.title':     'Curado Purple Octane 1.5g',
  'curado.po.blurb':     'A powerful, flavorful vape experience.',
  'curado.po.b1':        'Top-tier distillate',
  'curado.po.b2':        'High THC content',
  'curado.po.b3':        'Ready-to-use format',
  'curado.fruit.title':  'Curado Fruit 1.5g',
