...
const fr: Dict = {
  ...
  'curado.pbb.blurb':    'Hash temple ball 1,5 g, à spectre complet, élaboré à partir du cultivar hybride Peanut Butter Breath (Do-Si-Dos × Mendo Breath). Fumée douce et riche, saveur profonde, effets enveloppants et équilibrés.',
  'curado.pbb.b1':       'Temple ball 1,5 g — méthodes traditionnelles préservant l\'ensemble du profil cannabinoïdes et terpènes',
  'curado.pbb.b2':       'Cultivar : Peanut Butter Breath (Do-Si-Dos × Mendo Breath)',
  'curado.pbb.b3':       'THC 54,1 % · Terpènes totaux 2,82 %',
  'curado.pbb.b4':       'Profil : noisette, terreux, gazeux · Hybride · Effets profonds et relaxants',

  'curado.cb.title':     'Cali Biscotti Temple Ball',
  'curado.cb.blurb':     "Temple ball 1,5 g authentiquement vieilli, 3-4 mois minimum de maturation. Teneur élevée en terpènes (5,91 %) — profil crémeux et citronné, effets relaxants distinctifs.",
  'curado.cb.b1':        "Vieillissement signature Curado — 2-3 mois de cure + 1 mois de maturation supplémentaire",
  'curado.cb.b2':        "Terpènes totaux 5,91 % · THC 59,8 %",
  'curado.cb.b3':        "Fabriqué à la main par notre maître extracteur Simon Salomone",
  'curado.cb.b4':        "Profil : crémeux, zeste d'agrumes, notes d'orange tangerine",

  'curado.cj.title':     'Cap Junky Temple Ball',
  'curado.cj.blurb':     "Temple ball 1,5 g à spectre complet du cultivar hybride Cap Junky (Alien Cookies × Kush Mints #11). Nez gazeux marqué, fruit sucré et légère acidité, fumée enveloppante et expressive.",
  'curado.cj.b1':        'Cultivar : Cap Junky (Alien Cookies × Kush Mints #11)',
  'curado.cj.b2':        'Terpènes totaux 2,37 % · THC 59,98 %',
...
const en: Dict = {
  ...
  'curado.pbb.title':    'Peanut Butter Breath Temple Ball',
  'curado.pbb.blurb':    '1.5g full-spectrum temple ball hash crafted from the Peanut Butter Breath hybrid (Do-Si-Dos × Mendo Breath). Smooth, rich smoke with deep flavor and well-rounded, heavy-bodied effects.',
  'curado.pbb.b1':       '1.5g temple ball — traditional hash-making preserves the full cannabinoid and terpene spectrum',
  'curado.pbb.b2':       'Strain: Peanut Butter Breath (Do-Si-Dos × Mendo Breath)',
  'curado.pbb.b3':       'THC 54.1% · Total terpenes 2.82%',
  'curado.pbb.b4':       'Nutty, earthy, gassy profile · Hybrid · Heavy-bodied, relaxing effects',

  'curado.cb.title':     'Cali Biscotti Temple Ball',
  'curado.cb.blurb':     "Authentically aged 1.5g temple ball, 3-4 months minimum curing. High terpene content (5.91%) delivers a creamy, citrusy profile with distinctive relaxing effects.",
  'curado.cb.b1':        "Curado's signature aging — 2-3 months curing + 1 month additional maturation",
  'curado.cb.b2':        "Total terpenes 5.91% · THC 59.8%",
  'curado.cb.b3':        "Hand-crafted by our master extractor Simon Salomone",
  'curado.cb.b4':        "Profile: creamy, zesty citrus, tangy orange notes",

  'curado.cj.title':     'Cap Junky Temple Ball',
  'curado.cj.blurb':     "1.5g full-spectrum temple ball from the Cap Junky hybrid (Alien Cookies × Kush Mints #11). Sharp gassy nose, sweet fruit, slightly sour edge — full-bodied, expressive smoke.",
  'curado.cj.b1':        'Strain: Cap Junky (Alien Cookies × Kush Mints #11)',
