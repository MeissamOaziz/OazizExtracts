...
const fr: Dict = {
  ...
  'brands.tag.cannonfire':'VAPOTAGE',
  'brands.tag.curado':   'BUBBLE HASH',
  'brands.tag.canolio':  'Rosine Comestible',
  'brands.tag.xaman':    'TOPIQUES',
  'brands.tag.hashtisan':'HASHISH CLASSIQUES',
  ...
  // Rosin page
  'rosin.meta.title':    'Rosines et Vapes — Oaziz Extracts',
  'rosin.meta.desc':     'Rosines artisanales et formulations de vapes B2B : rosine pure, hybride rosine × distillat, distillat complet. Vrac, marque blanche, produit fini.',
  ...
  'rosin.ctx':           'Rosin & Vapes inquiry',

  'vapes.h2':            'Vapes — De la Rosine au Distillat',
  'vapes.intro':         "Notre programme de vapes couvre l'éventail complet de la qualité, de la rosine pure sans solvant au distillat haut de gamme. Approvisionnement en vrac, marque blanche, ou produit fini sous nos marques — pour les marchés canadiens comme à l'international.",
  'vapes.rosin.title':   'Vape de Rosine',
  'vapes.rosin.blurb':   "Rosine pure sans solvant en cartouche 510. L'expression la plus fidèle du cultivar — sans additifs, sans distillat.",
  'vapes.rosin.b1':      '100 % rosine sans solvant',
  'vapes.rosin.b2':      'Cartouches 510 ou formats jetables',
  'vapes.rosin.b3':      'Productions par cultivar sur demande',
  'vapes.rosin.b4':      'Gamme premium — vedette de la ligne CannonFire AUBE',
  'vapes.hybrid.title':  'Hybride : Rosine × Distillat',
  'vapes.hybrid.blurb':  'Mélanges équilibrés qui préservent la profondeur terpénique de la rosine tout en améliorant rendement et viscosité pour une performance constante.',
  'vapes.hybrid.b1':     'Ratios personnalisés rosine / distillat (50/50, 70/30, 30/70…)',
  'vapes.hybrid.b2':     'Rosine Live ou Cured comme matière première',
  'vapes.hybrid.b3':     'Terpènes botaniques ou dérivés du cultivar en option',
  'vapes.hybrid.b4':     'Conçu pour les SKUs médicaux comme récréatifs',
  'vapes.distillate.title': 'Distillat Complet',
  'vapes.distillate.blurb': 'Vapes au distillat haut de gamme pour un positionnement grand marché. Profils fruités, classiques ou propres à nos cultivars.',
  'vapes.distillate.b1':    'Distillat haut de gamme (généralement 85 %+ THC)',
  'vapes.distillate.b2':    'Cartouches 0,5 g, 1 g, 1,5 g + jetables',
  'vapes.distillate.b3':    'Profils de terpènes et saveurs personnalisés',
  'vapes.distillate.b4':    'Tarification adaptée aux programmes de distributeurs',
  'vapes.options.title': 'Trois niveaux d\'engagement',
  'vapes.options.body':  'Toutes nos formulations sont disponibles en **approvisionnement en vrac** (concentré brut ou cartouches remplies, votre emballage), en **marque blanche** (votre marque, notre production) ou en **produit fini** sous nos marques CannonFire, CURADO et Hazo.',
...
const en: Dict = {
  ...
  'brands.tag.cannonfire':'VAPES',
  'brands.tag.curado':   'BUBBLE HASH',
  'brands.tag.canolio':  'Edible Rosin',
  'brands.tag.xaman':    'TOPICALS',
  'brands.tag.hashtisan':'HASHISH CLASSICS',
  ...
  'rosin.meta.title':    'Rosin and Vapes — Oaziz Extracts',
  'rosin.meta.desc':     'Artisan rosin extracts plus B2B vape formulations: pure rosin, hybrid rosin × distillate, and full distillate. Bulk supply, white-label, finished product.',
  ...
  'vapes.h2':            'Vapes — From Rosin to Distillate',
  'vapes.intro':         'Our vape program spans the full quality spectrum, from pure solvent-free rosin to high-potency distillate. Bulk supply, white-label, or finished product under our brands — for the Canadian and international markets.',
  'vapes.rosin.title':   'Rosin Vape',
  'vapes.rosin.blurb':   'Pure solvent-free rosin in 510 cartridge format. The truest expression of the cultivar — no additives, no distillate.',
  'vapes.rosin.b1':      '100% solvent-free rosin',
  'vapes.rosin.b2':      '510-thread cartridges or disposable formats',
  'vapes.rosin.b3':      'Strain-specific runs available',
  'vapes.rosin.b4':      'Premium tier — flagship of our CannonFire AUBE line',
  'vapes.hybrid.title':  'Hybrid: Rosin × Distillate',
  'vapes.hybrid.blurb':  "Balanced blends that preserve rosin's terpene depth while extending yield and viscosity for consistent performance.",
  'vapes.hybrid.b1':     'Custom rosin / distillate ratios (50/50, 70/30, 30/70…)',
  'vapes.hybrid.b2':     'Live or Cured rosin as the starting material',
  'vapes.hybrid.b3':     'Botanical or strain-derived terpenes optional',
  'vapes.hybrid.b4':     'Built for both medical and recreational SKUs',
  'vapes.distillate.title': 'Full Distillate',
  'vapes.distillate.blurb': 'High-potency distillate vapes for broad-market positioning. Fruit, classic, and house-strain profiles available.',
  'vapes.distillate.b1':    'High-THC distillate (typically 85%+ THC)',
  'vapes.distillate.b2':    '0.5g, 1g, 1.5g cartridges + disposables',
  'vapes.distillate.b3':    'Custom terpene profiles and flavors',
  'vapes.distillate.b4':    'Volume-friendly pricing for distributor programs',
  'vapes.options.title': 'Three engagement levels',
  'vapes.options.body':  'All three formulations are available as **bulk supply** (raw concentrate or filled cartridges, your packaging), **white-label** (your brand, our production), or **finished product** under our CannonFire, CURADO, and Hazo brands.',
